...
interface IPermission extends PermissionInterface, IJsonObject {
    ...
    public const PERMISSION_RESET_PASSWORD_RESET_PASSWORD                   = 48;
    public const PERMISSION_NAME_RESET_PASSWORD_RESET_PASSWORD              = 'RESET_PASSWORD_RESET_PASSWORD';
    ...
    public const PERMISSION_SETTINGS_USER_UPDATE_PASSWORD                   = 54;
