...
/**
 * @deprecated - move to AppService
 */
class Diff {

    private ILoaderService $loader;

    public function __construct(ILoaderService $loader) {
        $this->loader = $loader;
    }

    public function needsUpgrade(IApp $loadedApp, InstalledApp $installedApp): bool {
