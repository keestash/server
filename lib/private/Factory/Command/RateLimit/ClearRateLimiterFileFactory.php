...
namespace Keestash\Factory\Command\RateLimit;
...
class ClearRateLimiterFileFactory implements FactoryInterface {

    public function __invoke(
        ContainerInterface $container
        ,                  $requestedName
        , ?array           $options = null
    ): ClearRateLimiterFile {
        ...
        return new ClearRateLimiterFile(
            $dataService
        );
    }
