...
class UpdatePassword extends KeestashCommand {
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        if (null === $user) {
            throw new UsersException('no user found for ' . $userId);
        }
        ...
        if (
            ...
            throw new UsersException('cannot update password for system user or demo user');
        }

        if ($password !== $passwordRepeat) {
            throw new UsersException('passwords do not match');
        }
        ...
        if (false === $requirementsMet) {
            throw new UsersException('the minimum requirements for passwords are not met');
        }
