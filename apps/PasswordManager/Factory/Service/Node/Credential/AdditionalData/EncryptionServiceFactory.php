...
namespace KSA\PasswordManager\Factory\Service\Node\Credential\AdditionalData;
...
class EncryptionServiceFactory implements FactoryInterface {
    ...
    public function __invoke(
        ...
        return new EncryptionService(
            $container->get(\KSA\PasswordManager\Service\Encryption\EncryptionService::class)
