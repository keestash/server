...
interface IResponseCodes {
    ...
    public const int    RESPONSE_CODE_NODE_SHARE_PUBLIC_INCORRECT_PASSWORD = 34561235;
    public const string RESPONSE_NAME_NODE_SHARE_PUBLIC_INCORRECT_PASSWORD = 'password.incorrect.public.share.node';
