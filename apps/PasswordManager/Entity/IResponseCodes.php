...
interface IResponseCodes {
    ...
    public const RESPONSE_CODE_NODE_NOT_FOUND                    = 442935;
    public const RESPONSE_NAME_NODE_NOT_FOUND                    = 'found.not.node';
    ...
    public const RESPONSE_CODE_NO_FILES_GIVEN                    = 143377;
    public const RESPONSE_NAME_NO_FILES_GIVEN                    = 'given.files.no';
    public const RESPONSE_CODE_NODE_ACCESS_UNAUTHORIZED          = 678534;
    public const RESPONSE_NAME_NODE_ACCESS_UNAUTHORIZED          = 'unauthorized.access.node';
    public const RESPONSE_CODE_NODE_ATTACHMENT_ADD_NO_NODE_FOUND = 891256;
    public const RESPONSE_NAME_NODE_ATTACHMENT_ADD_NO_NODE_FOUND = 'found.no.node.add.attachment.node';
